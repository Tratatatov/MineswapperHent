...
namespace Utilities.BetterHierarchy
{
    public static class UnityEditorBackgroundColor
    {
        ...
        public static Color Get(HierarchyObjectStatus hierarchyObjectStatus, bool isWindowFocused,
        ...
        private static SystemColor GetSystemColor(HierarchyObjectStatus obj, bool isWindowFocused,
            int selectedObjectsAmount = 0)
        {
            var isMouseDown = MouseStatus.IsMouseDown;
