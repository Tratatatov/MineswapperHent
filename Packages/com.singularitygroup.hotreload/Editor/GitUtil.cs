...
namespace SingularityGroup.HotReload.Editor
{
    internal static class GitUtil
    {
        ...
        private static bool loggedExceptionInGetShortCommitHashSafe;
        ...
        private static Process StartGitCommand(string command, string arguments,
            Action<ProcessStartInfo> modifySettings = null)
        {
            ...
            if (modifySettings != null) modifySettings(startInfo);
