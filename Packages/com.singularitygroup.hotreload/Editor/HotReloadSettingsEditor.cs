...
namespace SingularityGroup.HotReload.Editor
{
    internal static class HotReloadSettingsEditor
    {
        ...
        {
            if (!SettingsExists()) CreateNewSettingsFile(asset, HotReloadSettingsObject.editorAssetPath);
        }
        ...
        private static void CreateNewSettingsFile(HotReloadSettingsObject asset, string editorAssetPath)
        {
            ...
            if (asset == null) asset = ScriptableObject.CreateInstance<HotReloadSettingsObject>();
