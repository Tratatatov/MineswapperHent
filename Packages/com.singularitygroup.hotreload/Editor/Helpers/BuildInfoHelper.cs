...
namespace SingularityGroup.HotReload.Editor
{
    internal struct BuildInfoInput
    {
        ...
        public BuildInfoInput(string allDefineSymbols, BuildTarget activeBuildTarget, string[] omittedProjects,
            bool batchMode)
        {
    ...
    internal static class BuildInfoHelper
    {
        ...
        {
            var allDefineSymbols =
                GetAllAndroidMonoBuildDefineSymbolsThreaded(EditorUserBuildSettings.activeScriptCompilationDefines);
            return GenerateBuildInfoThreaded(new BuildInfoInput(
                allDefineSymbols,
                buildTarget,
                AssemblyOmission.GetOmittedProjects(allDefineSymbols),
