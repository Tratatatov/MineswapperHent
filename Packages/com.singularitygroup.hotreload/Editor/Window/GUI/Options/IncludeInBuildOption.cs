...
namespace SingularityGroup.HotReload.Editor
{
    ...
    {
        private static readonly IncludeInBuildOption _I;
        ...
        public override void InnerOnGUI(SerializedObject so)
        {
            ...
            if (GetValue(so))
                description =
                    "The Hot Reload runtime is included in development builds that use the Mono scripting backend.";
            else
                description =
                    "The Hot Reload runtime will not be included in any build. Use this option to disable HotReload without removing it from your project.";
