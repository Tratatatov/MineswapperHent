        ...
        public static Texture2D Black
        {
            get
            {
                if (!black)
                {
                    ...
                    for (var i = 0; i < pixels.Length; i++) pixels[i] = new Color32(0, 0, 0, byte.MaxValue);
        ...
        public static Texture2D DarkGray17
        {
            get
            {
                if (!darkGray17)
                {
                    ...
                    for (var i = 0; i < pixels.Length; i++) pixels[i] = new Color32(17, 17, 17, byte.MaxValue);
        ...
        public static Texture2D DarkGray40
        {
            get
            {
                if (!darkGray30)
                {
                    ...
                    for (var i = 0; i < pixels.Length; i++) pixels[i] = new Color32(40, 40, 40, byte.MaxValue);
        ...
        public static Texture2D LightGray238
        {
            get
            {
                if (!lightGray235)
                {
                    ...
                    for (var i = 0; i < pixels.Length; i++) pixels[i] = new Color32(238, 238, 238, byte.MaxValue);
        ...
        public static Texture2D LightGray225
        {
            get
            {
                if (!lightGray225)
                {
                    ...
                    for (var i = 0; i < pixels.Length; i++) pixels[i] = new Color32(225, 225, 225, byte.MaxValue);
