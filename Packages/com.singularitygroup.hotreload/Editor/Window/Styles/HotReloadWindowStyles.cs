...
namespace SingularityGroup.HotReload.Editor
{
    internal static class HotReloadWindowStyles
    {
        ...
        public static int windowScreenWidth =>
            HotReloadWindow.Current ? (int)HotReloadWindow.Current.position.width : Screen.width;

        public static int windowScreenHeight =>
            HotReloadWindow.Current ? (int)HotReloadWindow.Current.position.height : Screen.height;
        ...
        public static GUIStyle NotificationsTitleStyle
        {
            get
            {
                ...
                {
                    notificationsTitleStyle = new GUIStyle(H3TitleStyle);
        ...
        public static GUIStyle BoxStyle
        {
            get
            {
                ...
                if (!IsDarkMode) boxStyle.normal.background = Texture2D.blackTexture;
                return boxStyle;
            }
        }
        ...
        public static GUIStyle IndicationIcon
        {
            get
            {
                ...
                indicationIconStyle.padding =
                    new RectOffset(windowScreenWidth > Constants.IndicationTextHideWidth ? 7 : 5,
                        windowScreenWidth > Constants.IndicationTextHideWidth ? 0 : -10, 1, 1);
        ...
        public static GUIStyle IndicationAlertIcon
        {
            get
            {
                if (indicationAlertIconStyle == null)
                {
                    ...
                    indicationAlertIconStyle.padding = new RectOffset(5, -7, 1, 1);
        ...
        public static GUIStyle StopButton
        {
            get
            {
                ...
                stopButtonStyle.fixedWidth = windowScreenWidth > Constants.StartButtonTextHideWidth ? 70 : 30;
        ...
        public static GUIStyle SectionInnerBox
        {
            get
            {
                if (sectionInnerBoxStyle == null) sectionInnerBoxStyle = new GUIStyle();
                sectionInnerBoxStyle.padding = new RectOffset(0, 0, 15, 0);
        ...
        public static GUIStyle DynamiSection
        {
            get
            {
                if (dynamicSection == null) dynamicSection = new GUIStyle();
        ...
        public static GUIStyle DynamicSectionHelpTab
        {
            get
            {
                if (dynamicSectionHelpTab == null) dynamicSectionHelpTab = new GUIStyle(DynamiSection);
        ...
        public static GUIStyle IndicationBox
        {
            get
            {
                if (indicationBoxStyle == null) indicationBoxStyle = new GUIStyle();
        ...
        private static Color32 DarkModeLinkColor
        {
            get
            {
                if (darkModeLinkColor == null) darkModeLinkColor = new Color32(0x3F, 0x9F, 0xFF, 0xFF);
        ...
        private static Color32 LightModeModeLinkColor
        {
            get
            {
                if (lightModeModeLinkColor == null) lightModeModeLinkColor = new Color32(0x0F, 0x52, 0xD7, 0xFF);
        ...
        public static GUIStyle ProgressBarBarStyle
        {
            get
            {
                if (progressBarBarStyle != null) return progressBarBarStyle;
        ...
        internal static GUIStyle Section
        {
            get
            {
                if (section == null)
                {
                    ...
                    section.margin = new RectOffset(0, 0, 0, 0);
                }
        ...
        internal static GUIStyle Scroll
        {
            get
            {
                if (scroll == null) scroll = new GUIStyle(EditorStyles.helpBox);
                if (IsDarkMode)
        ...
        internal static GUIStyle BarBackgroundStyle
        {
            get
            {
                if (barBgStyle == null) barBgStyle = new GUIStyle();
        ...
        internal static GUIStyle ChildBarStyle
        {
            get
            {
                if (barChildStyle == null)
                {
                    ...
                    barChildStyle.padding = new RectOffset(43, barChildStyle.padding.right, barChildStyle.padding.top,
                        barChildStyle.padding.bottom);
                }
        ...
        internal static GUIStyle FoldoutBarStyle
        {
            get
            {
                if (barFoldoutStyle == null)
                {
                    ...
                    barFoldoutStyle.padding = new RectOffset(23, barFoldoutStyle.padding.right,
                        barFoldoutStyle.padding.top, barFoldoutStyle.padding.bottom);
                }
        ...
        public static GUIStyle TimestampStyle
        {
            get
            {
                if (timestampStyle == null) timestampStyle = new GUIStyle(GUI.skin.label);
                if (IsDarkMode)
        ...
        internal static GUIStyle HideButtonStyle
        {
            get
            {
                if (hideButtonStyle == null) hideButtonStyle = new GUIStyle(GUI.skin.button);
