...
namespace SingularityGroup.HotReload.Interop
{
    ...
    internal enum MethodImplAttributes : ushort
    {
        ...
        /// <summary>
        ///     <para>Specifies that the method is implemented in managed code. </para>
        /// </summary>
        Managed = 0,
        ...
        /// <summary>
        ///     <para>Specifies whether the method is implemented in managed or unmanaged code.</para>
        /// </summary>
        ManagedMask = 4,
        ...
        /// <summary>
        ///     <para>
        ///         Specifies that the method is single-threaded through the body. Static methods (Shared in Visual Basic) lock on
        ///         the type, whereas instance methods lock on the instance. You can also use the C#
        ///         <format type="text/html">
        ///             <a href="656DA1A4-707E-4EF6-9C6E-6D13B646AF42">lock statement</a>
        ///         </format>
        ///         or the Visual Basic
        ///         <format type="text/html">
        ///             <a href="14501703-298f-4d43-b139-c4b6366af176">SyncLock statement</a>
        ///         </format>
        ///         for this purpose.
        ///     </para>
        /// </summary>
        ...
        /// <summary>
        ///     <para>
        ///         Specifies that the method is not optimized by the just-in-time (JIT) compiler or by native code generation (see
        ///         <format type="text/html">
        ///             <a href="44bf97aa-a9a4-4eba-9a0d-cfaa6fc53a66">Ngen.exe</a>
        ///         </format>
        ...
        /// <summary>
        ///     <para>Specifies that the method should be inlined wherever possible.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para>Specifies flags for method attributes. These flags are defined in the corhdr.h file.</para>
    /// </summary>
    [Flags]
    internal enum MethodAttributes : ushort
    {
        /// <summary>
        ///     <para>Retrieves accessibility information.</para>
        /// </summary>
        MemberAccessMask = 7,

        /// <summary>
        ///     <para>Indicates that the member cannot be referenced.</para>
        /// </summary>
        PrivateScope = 0,

        /// <summary>
        ///     <para>Indicates that the method is accessible only to the current class.</para>
        /// </summary>
        Private = 1,

        /// <summary>
        ///     <para>
        ///         Indicates that the method is accessible to members of this type and its derived types that are in this
        ///         assembly only.
        ///     </para>
        /// </summary>
        FamANDAssem = 2,
        ...
        /// <summary>
        ///     <para>Indicates that the method is accessible to any class of this assembly.</para>
        /// </summary>
        Assembly = FamANDAssem | Private, // 0x00000003

        /// <summary>
        ///     <para>Indicates that the method is accessible only to members of this class and its derived classes.</para>
        /// </summary>
        Family = 4,

        /// <summary>
        ///     <para>Indicates that the method is accessible to derived classes anywhere, as well as to any class in the assembly.</para>
        /// </summary>
        FamORAssem = Family | Private, // 0x00000005

        /// <summary>
        ///     <para>Indicates that the method is accessible to any object for which this object is in scope.</para>
        /// </summary>
        Public = Family | FamANDAssem, // 0x00000006

        /// <summary>
        ///     <para>Indicates that the method is defined on the type; otherwise, it is defined per instance.</para>
        /// </summary>
        Static = 16, // 0x00000010

        /// <summary>
        ///     <para>Indicates that the method cannot be overridden.</para>
        /// </summary>
        Final = 32, // 0x00000020

        /// <summary>
        ///     <para>Indicates that the method is virtual.</para>
        /// </summary>
        Virtual = 64, // 0x00000040

        /// <summary>
        ///     <para>Indicates that the method hides by name and signature; otherwise, by name only.</para>
        /// </summary>
        HideBySig = 128, // 0x00000080

        /// <summary>
        ///     <para>Indicates that the method can only be overridden when it is also accessible.</para>
        /// </summary>
        CheckAccessOnOverride = 512, // 0x00000200

        /// <summary>
        ///     <para>Retrieves vtable attributes.</para>
        /// </summary>
        VtableLayoutMask = 256, // 0x00000100

        /// <summary>
        ///     <para>Indicates that the method will reuse an existing slot in the vtable. This is the default behavior.</para>
        /// </summary>
        ReuseSlot = 0,

        /// <summary>
        ///     <para>Indicates that the method always gets a new slot in the vtable.</para>
        /// </summary>
        NewSlot = VtableLayoutMask, // 0x00000100

        /// <summary>
        ///     <para>Indicates that the class does not provide an implementation of this method.</para>
        /// </summary>
        Abstract = 1024, // 0x00000400

        /// <summary>
        ///     <para>Indicates that the method is special. The name describes how this method is special.</para>
        /// </summary>
        SpecialName = 2048, // 0x00000800

        /// <summary>
        ///     <para>Indicates that the method implementation is forwarded through PInvoke (Platform Invocation Services).</para>
        /// </summary>
        PinvokeImpl = 8192, // 0x00002000

        /// <summary>
        ///     <para>Indicates that the managed method is exported by thunk to unmanaged code.</para>
        /// </summary>
        UnmanagedExport = 8,
        ...
        /// <summary>
        ///     <para>Indicates a reserved flag for runtime use only.</para>
        /// </summary>
        ReservedMask = 53248, // 0x0000D000

        /// <summary>
        ///     <para>Indicates that the method has security associated with it. Reserved flag for runtime use only.</para>
        /// </summary>
        HasSecurity = 16384, // 0x00004000

        /// <summary>
        ///     <para>Indicates that the method calls another method containing security code. Reserved flag for runtime use only.</para>
        /// </summary>
