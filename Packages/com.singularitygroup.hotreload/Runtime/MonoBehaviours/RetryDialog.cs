...
namespace SingularityGroup.HotReload
{
    internal class RetryDialog : MonoBehaviour
    {
        ...
        [Header("UI controls")] public Button buttonHide;
        ...
        [Tooltip("Hidden by default")] public Text textForDebugging;
        ...
        {
            set => textForDebugging.text = value;
        }

        public bool autoConnect { get; set; }

        [CanBeNull] public static PatchServerInfo TargetServer { private get; set; } = null;
        ...
        {
            ipInput.text =
                $"{PlayerEntrypoint.PlayerBuildInfo?.buildMachineHostName}:{PlayerEntrypoint.PlayerBuildInfo?.buildMachinePort}";
            UpdateUI();
        }
        ...
        private void UpdateUI()
        {
            ...
            var targetNetworkIsReachable =
                $"Make sure you're on the same {networkText} network. Also ensure Hot Reload is running";
