...
namespace SingularityGroup.HotReload
{
    internal class Prompts : MonoBehaviour
    {
        ...
        [Header("Other")] [Tooltip("Used when project does not create an EventSystem early enough")]
        ...
        public static void SetConnectionState(string state, bool log = true)
        {
            ...
            if (connectionDialog) connectionDialog.SetSummary(state);
        }
        ...
        /// <summary>
        ///     All usages must check that <see cref="PlayerEntrypoint.RuntimeSupportsHotReload" /> is true before accessing this
        ///     singleton.
        /// </summary>
        /// <remarks>
        ///     This getter can throw on unsupported platforms (HotReloadSettingsObject resource doesn't exist on unsupported
        ///     platforms).
        /// </remarks>
        ...
        private bool userTriedToInteract;
